...
import { fetchBudgetVoteOnAccount } from "../services/MasterService";
...
const VoteOnAccount = () => {
  ...
  useEffect(() => {
    ...
    fetchBudgetVoteOnAccount()
      ...
      .catch((err) => {
        console.error("Failed to load budget vote on account:", err);
  ...
  return (
    <div className="wrapper ovh">
      ...
      <div className="body_content">
        <CategoriesNav />
        <BreadcrumbNav breadcrumbs={[{ name: "Home", href: "/" }, { name: "Business", href: "/business" }, { name: "Budget Vote on Account", href: "/budget-vote-on-account" }]} />
        <section className="Bussiness-schedule quest pt20 pb-30 pb30-md represent">
          <div className="container">
            <SectionTitle title="Budget Vote on Account" />
